import React, { useState } from 'react'; // Poistettu useEffect, koska emme käytä ajastinta
...
// CSS Tuonnit (pidä nämä ennallaan)
...
const App: React.FC = () => {
  // Tila: näytetäänkö Splash Screen (oletus: true)
  const [showSplash, setShowSplash] = useState(true);

  return (
    <IonApp>
      {/* EHDOTUS:
         Jos showSplash on tosi, näytetään VAIN SplashScreen.
         Kun käyttäjä painaa nappia, showSplash muuttuu falseksi ja reititin renderöidään.
      */}
      {showSplash ? (
